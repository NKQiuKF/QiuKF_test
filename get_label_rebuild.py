...
'''
API_KEYS = ['15b87efcbe3b10c9674ad9e312e2b3c9820316a4532c5afb561f6f7922f4331a',
...
LABEL_TODO_LIST='label_todo_list.csv'
...
def write_action(dict_csv,dst_path):
  try:
    front = dict_csv['sha256'][0][:3]
  except Exception,e:
    print e,1

    return
  file_path = "{0}/{1}/{2}/{3}/{4}".format(dst_path, front[0],front[1],front[2],'reports.csv')
